...
R package **mrmfa**, version **1.13.0**
...
Dürrwächter J, Weiss B, Schweiger L, Benke F, Hosak M, Zhang Q (2026). "mrmfa: Input data generation for the REMIND MFA." Version: 1.13.0, <https://github.com/pik-piam/mrmfa>.
