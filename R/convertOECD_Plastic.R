...
convertOECD_Plastic <- function(x) {
  ...
  if (subtype == "Use_1990-2019_region") {
    ...
    GDP <- calcOutput("CoGDP1900To2150", scenarios = "SSP2", perCapita = FALSE, aggregate = FALSE)[, paste0("y", 1990:2019), ]
    ...
    manu_map <- toolGetMapping("structuremappingPlasticManu.csv", type = "sectoral", where = "mrmfa")
    ...
    GDP2019 <- calcOutput("CoGDP1900To2150", scenarios = "SSP2", perCapita = FALSE, aggregate = FALSE)[, "y2019", ]
    ...
    manu_map16 <- toolGetMapping("structuremappingPlasticManu_16.csv", type = "sectoral", where = "mrmfa")
