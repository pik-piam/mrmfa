...
convertOECD_Plastic <- function(x) {
  ...
  if (subtype == "Use_1990-2019_region") {
    ...
    GDP <- calcOutput("CoGDP", scenarios = "SSP2", perCapita = FALSE, aggregate = FALSE)[, paste0("y", 1990:2019), ]
    ...
    GDP2019 <- calcOutput("CoGDP", scenarios = "SSP2", perCapita = FALSE, aggregate = FALSE)[, "y2019", ]
