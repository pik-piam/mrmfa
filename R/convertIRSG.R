...
#' and restricted to the rubber \code{type}). Note that exports are an imperfect proxy:
#' producers serving mainly domestic demand are under-weighted and re-export hubs slightly
#' over-weighted.
#'
