...
#' @param driverScenario Character vector specifying the scenario to use for GDP and population data.
...
fullMFA <- function(rev = 0,
                    dev = "",
                    gdpPerCapita = TRUE,
                    driverScenario = c("SSP1", "SSP2", "SSP3", "SSP4", "SSP5"),
                    runSections = NULL,
                    end_future = 2100) {
  ...
  if (runSection("steel")) {
    ...
    # common parameters
    calcOutput("CoPopulation1900To2150", file = "st_population.cs4r", scenario = driverScenario, collapse = FALSE, smooth = TRUE, years = start_historic:end_future)
    calcOutput("CoGDP1900To2150", file = "st_gdppc.cs4r", perCapita = gdpPerCapita, scenario = driverScenario, collapse = FALSE, smooth = TRUE, years = start_historic:end_future)
  ...
  if (runSection("cement")) {
    ...
    # common parameters
    calcOutput("CoPopulation1900To2150", file = "ce_population.cs4r", scenario = driverScenario, collapse = FALSE, smooth = TRUE, years = start_historic:end_future)
    calcOutput("CoGDP1900To2150", file = "ce_gdppc.cs4r", perCapita = gdpPerCapita, scenario = driverScenario, collapse = FALSE, smooth = TRUE, years = start_historic:end_future)
    # Production
  ...
  if (runSection("plastic")) {
    ...
    # common parameters
    calcOutput("CoPopulation1900To2150", file = "pl_population.cs4r", scenario = driverScenario, collapse = FALSE, smooth = TRUE, years = start_historic:end_future)
    calcOutput("CoGDP1900To2150", file = "pl_gdppc.cs4r", perCapita = gdpPerCapita, scenario = driverScenario, collapse = FALSE, smooth = TRUE, years = start_historic:end_future)
    # Consumption
