...
fullMFA <- function(rev = 0, dev = "", scenario = "SSP2", gdpPerCapita = TRUE, runSections = NULL,
  ...
  if (runSection("plastic")) {
    ...
    calcOutput("PlTrade", category = "Application", flow_label = "Exports", data_source = "BACI", aggregate=FALSE, file = "pl_final_his_exports.cs4r", years = start_historic:end_historic)
    calcOutput("PlTrade", category = "Application", flow_label = "Imports", data_source = "BACI", aggregate=FALSE, file = "pl_final_his_imports.cs4r", years = start_historic:end_historic)
    calcOutput("PlTrade", category = "Primary", flow_label = "Exports", data_source = "BACI", aggregate=FALSE, file = "pl_primary_his_exports.cs4r", years = start_historic:end_historic)
    calcOutput("PlTrade", category = "Primary", flow_label = "Imports", data_source = "BACI", aggregate=FALSE, file = "pl_primary_his_imports.cs4r", years = start_historic:end_historic)
    calcOutput("PlTrade", category = "Waste", flow_label = "Exports", data_source = "BACI", aggregate=FALSE, file = "pl_waste_his_exports.cs4r", years = start_historic:end_historic)
    calcOutput("PlTrade", category = "Waste", flow_label = "Imports", data_source = "BACI", aggregate=FALSE, file = "pl_waste_his_imports.cs4r", years = start_historic:end_historic)
    # Parameters
