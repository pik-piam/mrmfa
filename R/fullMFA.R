...
fullMFA <- function(rev = 0, dev = "", scenario = "SSP2", gdpPerCapita = TRUE, runSections = NULL,
  ...
  if (runSection("steel")) {
    ...
    calcOutput("StBACI", file = "st_steel_imports.cs4r", subtype = "imports", category="direct", years = start_historic:end_historic)
    calcOutput("StBACI", file = "st_steel_exports.cs4r", subtype = "exports", category="direct", years = start_historic:end_historic)
    calcOutput("StBACI", file = "st_scrap_imports.cs4r", subtype = "imports", category="scrap", years = start_historic:end_historic)
    calcOutput("StBACI", file = "st_scrap_exports.cs4r", subtype = "exports", category="scrap", years = start_historic:end_historic)
    calcOutput("StBACI", file = "st_indirect_imports.cs4r", subtype = "imports", category="indirect", years = start_historic:end_historic)
    calcOutput("StBACI", file = "st_indirect_exports.cs4r", subtype = "exports", category="indirect", years = start_historic:end_historic)
