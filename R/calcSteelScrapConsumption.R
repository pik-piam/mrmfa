...
calcSteelScrapConsumptionOnlyLinear <- function(consumptionData) {
  ...
  scrapConsumptionWS <- calcWorldSteelScrapConsumption(consumptionData$historic,
                                                       consumptionData$recent,
                                                       consumptionData$current)
  
  scrapConsumption <- combineWSandBIRscrapConsumption(scrapConsumptionWS,
                                                      consumptionData$bir)
...
calcWorldSteelScrapConsumption <- function(historic, recent, current) {
  ...
  scrapConsumptionWS <- new.magpie(cells_and_regions = allRegions,
